...
The data folder has a sub-folder called 'Pavlovia' that has one csv file for every run of the online experiment that was recorded. Some participants have apparently done the task twice (or more), some may not have finished the task and others may not appear in the questionnaire data.
...
The figures generated in this notebook can also be written to pdf or png files (more if you change the functions), which can be done here:
